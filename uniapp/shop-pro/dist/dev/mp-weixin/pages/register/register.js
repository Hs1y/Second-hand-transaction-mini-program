    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: common_vendor.p({
          prop: "phone",
          ["left-icon"]: "phone",
          ["left-icon-style"]: "font-size:24px;color:#13D269;"
        }),
        ...
        q: common_vendor.sr(form1, "4a4bc058-0", {
          "k": "form1"
        }),
        r: common_vendor.p({
          model: loginModel
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/旧物新缘/uniapp/shop-pro/src/pages/register/register.vue"]]);
