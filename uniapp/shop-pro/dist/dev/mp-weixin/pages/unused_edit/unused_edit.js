  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        I: common_vendor.sr(imgRef, "ad3bf9c8-22,ad3bf9c8-0", {
          "k": "imgRef"
        }),
        J: common_vendor.o(onRemove),
        K: common_vendor.o(onChange),
        L: common_vendor.p({
          ["file-list"]: fileList.value,
          action: action.value
        }),
        M: common_vendor.sr(form1, "ad3bf9c8-0", {
          "k": "form1"
        }),
        N: common_vendor.p({
          model: addModel
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/旧物新缘/uniapp/shop-pro/src/pages/unused_edit/unused_edit.vue"]]);
