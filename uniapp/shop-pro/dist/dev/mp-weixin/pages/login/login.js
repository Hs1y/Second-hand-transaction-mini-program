  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        m: common_vendor.sr("form1", "85c7d770-1"),
        n: common_vendor.p({
          model: loginModel
        })
      };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/旧物新缘/uniapp/shop-pro/src/pages/login/login.vue"]]);
