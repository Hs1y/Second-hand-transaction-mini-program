  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        q: common_vendor.o(($event) => addModel.userName = $event),
        r: common_vendor.p({
          disabled: true,
          placeholder: "请输入联系人",
        ...
        t: common_vendor.o(($event) => addModel.phone = $event),
        v: common_vendor.p({
          disabled: true,
          placeholder: "请输入联系电话",
        ...
        x: common_vendor.o(($event) => addModel.wxNum = $event),
        y: common_vendor.p({
          disabled: true,
          placeholder: "请输入微信号",
        ...
        A: common_vendor.o(($event) => addModel.address = $event),
        B: common_vendor.p({
          disabled: true,
        ...
        E: common_vendor.sr(imgRef, "3201463c-21,3201463c-0", {
          "k": "imgRef"
        }),
        F: common_vendor.p({
        ...
        G: common_vendor.sr(form1, "3201463c-0", {
          "k": "form1"
        }),
        H: common_vendor.p({
          model: addModel
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/旧物新缘/uniapp/shop-pro/src/pages/look_unused/look_unused.vue"]]);
