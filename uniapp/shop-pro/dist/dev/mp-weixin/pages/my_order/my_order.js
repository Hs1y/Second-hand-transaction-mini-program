...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getMyCollect = async () => {
      let res = await api_order.getMyOrderApi(parm);
      if (res && res.code == 200) {
        console.log(res);
    ...
    const confirm = async () => {
      ...
      let res = await api_order.deleteOrderApi({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/旧物新缘/uniapp/shop-pro/src/pages/my_order/my_order.vue"]]);
