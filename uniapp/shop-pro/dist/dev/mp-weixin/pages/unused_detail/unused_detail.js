...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const confirm = async () => {
      ...
      let res = await api_order.replaceOrderApi(addModel);
      if (res && res.code == 200) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        B: common_vendor.o(toBuy),
        C: common_vendor.o(($event) => addModel.price = $event),
        D: common_vendor.p({
          modelValue: addModel.price
        }),
        E: common_vendor.p({
          label: "请输入交易金额",
          prop: "price"
        }),
        F: common_vendor.sr("form1", "0adf272c-8,0adf272c-7"),
        G: common_vendor.p({
          ["label-width"]: "auto",
          model: addModel
        }),
        ...
        Q: common_vendor.sr("form1", "0adf272c-14,0adf272c-13"),
        R: common_vendor.p({
          ["label-width"]: "auto",
          model: reportModel
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/旧物新缘/uniapp/shop-pro/src/pages/unused_detail/unused_detail.vue"]]);
