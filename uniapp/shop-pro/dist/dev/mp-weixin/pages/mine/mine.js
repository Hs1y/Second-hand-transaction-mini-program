  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        i: common_vendor.o(toMyBy),
        j: common_vendor.p({
          icon: "photo",
          title: "我的求购"
        }),
        k: common_vendor.o(toCollect),
        l: common_vendor.p({
          icon: "heart",
          title: "我的收藏"
        }),
        m: common_vendor.o(toOrder),
        n: common_vendor.p({
          icon: "red-packet",
          title: "购买订单"
        }),
        o: common_vendor.o(toSellOrder),
        p: common_vendor.p({
          icon: "order",
          title: "出售订单"
        }),
        q: common_vendor.o(toUpdate),
        r: common_vendor.p({
          icon: "edit-pen",
          title: "修改密码"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/旧物新缘/uniapp/shop-pro/src/pages/mine/mine.vue"]]);
