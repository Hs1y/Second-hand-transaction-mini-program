...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getUsedList = async () => {
      let res = await api_goods.getUsedListApi({
    ...
    return (_ctx, _cache) => {
      return {
        ...
        i: common_vendor.sr(uWaterfall1, "5d8809f4-2", {
          "k": "uWaterfall1"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/旧物新缘/uniapp/shop-pro/src/pages/unused/unused.vue"]]);
